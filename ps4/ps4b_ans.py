...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i, let in enumerate(lower_let):
            new_shift = int((i+shift)%26)
            dict[let] = lower_let[new_shift]
        
        for i, let in enumerate(upper_let):
            dict[let] = upper_let[new_shift]
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        best_msg = self.apply_shift(best_shift)
